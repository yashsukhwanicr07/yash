...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>Capstore | Merchant | Delete Products</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
		 ...
		 <form action="merchant_home.html">
             <table id="product" class="table table-striped table-bordered" style="width:100%">
				...
				<tbody>
				<a:forEach items="${products}" var="prod">
				
				<td>${prod.prodId}</td>
				<td>${prod.name}</td>
				<td><button type="button" class="btn btn-danger" onclick="javascript:window.location.href='deleteProduct?id=${prod.prodId}'" >Remove</button></td>
				</tbody>
	...
	<script>
	function check(){
var r = confirm("Confirm to delete the product");
if(r==true)
{
